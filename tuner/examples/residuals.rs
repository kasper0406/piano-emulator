//! The measurements behind `TUNING_REPORT.md`: what stage 1 could not fit, and
...
//!
//! ```text
//! cargo run --release --example residuals -- [data/salamander] [presets/salamander-c5.toml]
//! ```
//!
...
/// Velocity the control renders are struck at, matching `salamander_ab`.
